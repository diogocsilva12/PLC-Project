...
_lr_productions = [
  ...
  ('Decl -> VAR NAME [ Expr ] [ Expr ]','Decl',8,'p_MatrixDecl','YaccTP.py',67),
  ...
  ('Assign -> NAME [ NUM ] = Expr','Assign',6,'p_ArrayAssign','YaccTP.py',146),
  ('Assign -> NAME [ Expr ] [ Expr ] = Expr','Assign',9,'p_MatrixAssign','YaccTP.py',158),
  ('Expr -> Condition','Expr',1,'p_Expr_condition','YaccTP.py',174),
  ('Expr -> Variable','Expr',1,'p_Expr','YaccTP.py',179),
  ('Expr -> NUM','Expr',1,'p_expression_number','YaccTP.py',184),
  ...
  ('Condition -> Expr EQ Expr','Condition',3,'p_condLog','YaccTP.py',215),
  ('Condition -> Expr NEQ Expr','Condition',3,'p_condLog','YaccTP.py',216),
  ('Condition -> ! Expr','Condition',2,'p_condLog','YaccTP.py',217),
  ('Condition -> Expr > Expr','Condition',3,'p_condLog','YaccTP.py',218),
  ('Condition -> Expr MOREEQ Expr','Condition',3,'p_condLog','YaccTP.py',219),
  ('Condition -> Expr < Expr','Condition',3,'p_condLog','YaccTP.py',220),
  ('Condition -> Expr LESSEQ Expr','Condition',3,'p_condLog','YaccTP.py',221),
  ('Condition -> Expr AND Expr','Condition',3,'p_condLog','YaccTP.py',222),
  ('Condition -> Expr OR Expr','Condition',3,'p_condLog','YaccTP.py',223),
